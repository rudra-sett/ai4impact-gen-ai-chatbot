    ...
    'query': {
      "span_near": {
        "clauses": [
          ...
          {"span_or": {
            "clauses": [
              { "span_term": { "text_field": "amends" } },
              { "span_term": { "text_field": "amended" } },
              { "span_term": { "text_field": "repealed" } },
              { "span_term": { "text_field": "inserted" } },
              { "span_term": { "text_field": "altered" } },
              { "span_term": { "text_field": "revised" } },
              { "span_term": { "text_field": "substituted" } },
              { "span_term": { "text_field": "added" } },
              { "span_term": { "text_field": "deleted" } },
              { "span_term": { "text_field": "omitted" } },
              { "span_term": { "text_field": "changed" } },
              { "span_term": { "text_field": "renumbered" } },
              { "span_term": { "text_field": "updated" } },
              { "span_term": { "text_field": "reinstated" } },
              { "span_term": { "text_field": "repeal" } },
              { "span_term": { "text_field": "revised" } },
              { "span_term": { "text_field": "modified" } },
              { "span_term": { "text_field": "enacted" } },
              { "span_term": { "text_field": "clarified" } },
              { "span_term": { "text_field": "reorganized" } },
              { "span_term": { "text_field": "superseded" } },
              { "span_term": { "text_field": "transferred" } },
              { "span_term": { "text_field": "codified" } },
              { "span_term": { "text_field": "supplemented" } }
            ]
        }
