  ...
  async getStreamedResponse(system, history) {
    ...
    const payload = {
      ...
      "tools": [
        ...
        //   "description": "Send a list of amendments to the client. Only send each unique amendment. Only send amendments where the amending act is different from the amended act.",
        //   "input_schema": {
        //     "type": "object",
        //     "properties": {
        //       "amendments": {
        ...
        //       "law_name" : {
        //         "type" : "string",
        //         "description" : "The law being amended."
        //       }
        //     },
        //     "required": [
        //       "amendments",
