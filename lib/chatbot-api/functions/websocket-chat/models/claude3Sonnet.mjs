    ...
    const payload = {
      ...
      "tools": [
        ...
        },
        {
          ...
          "description": "Send a full list of amendments to a specified act to the client. Only include each unique amendment. You will need to use the find_references tool before using this tool.",
          "input_schema": {
            "type": "object",
            "properties": {
              "amendments": {
