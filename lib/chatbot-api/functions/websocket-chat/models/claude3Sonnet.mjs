    ...
    const payload = {
      ...
      "tools": [
        ...
        },
        {
          ...
          "description": "Send a full list of amendments to a specified act to the client. Only send each unique amendment. Only send amendments where the amending act is different from the amended act. You will need to use the find_references tool before using this tool.",
          "input_schema": {
            "type": "object",
            "properties": {
              "amendments": {
                "type": "array",
                "description": "A list of non-duplicate amendments to a specific law being amended.",
                "items": {
                  "type": "object",
                  "properties": {                    
                    "amending_act": { "type": "string" },
                    "amendment_description" : {"type" : "string"}
                  },
