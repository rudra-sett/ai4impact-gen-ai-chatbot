          ...
          "properties": {
            "amendments": {
              ...
              "items": {
                "type": "object",
                "properties": {                    
                  "amendment_year": { "type": "string", "description": "The year of the amending Act from the corresponding amending_act_file_name. Must be a single year." },
                  "amendment_chapter": { "type": "string", "description": "The chapter number of the amending Act from the corresponding amending_act_file_name. Must be a single chapter number." },
                  "amendment_description" : {
                    "type" : "string", 
                    "description": "A detailed summary of the amendment. If multiple changes are made, include everything."
                  }
                },
                "required": ["amendment_year","amendment_chapter","amendment_description"]
              }
            },              
          },
          "required": [
