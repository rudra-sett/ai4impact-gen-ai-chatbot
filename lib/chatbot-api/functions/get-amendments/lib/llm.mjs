          ...
          "properties": {
            "amendments": {
              ...
              "items": {
                "type": "object",
                "properties": {                    
                  "amendment_year": { "type": "string", "description": "The year of the amending Act. Must be a single year." },
                  "amendment_chapter": { "type": "string", "description": "The chapter number of the amending Act. Must be a single chapter number." },
